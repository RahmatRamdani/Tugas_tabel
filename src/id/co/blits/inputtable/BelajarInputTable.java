 ...
 */
package id.co.blits.inputtable;
 ...
 * @author user
 */
public class BelajarInputTable extends javax.swing.JFrame {

    /**
     * Creates new form BelajarInputTable
     */
    public BelajarInputTable() {
        initComponents();
    ...
    @SuppressWarnings("unchecked")
     ...
     void bersih(){
        jTextFieldNama.setText(null); //membersihkan textfield
        jTextFieldAsal.setText(""); //membersihkan textfield
        jTextFieldNama.requestFocus(); //untuk setfocus
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String nama = jTextFieldNama.getText().trim(); //trim untuk pemanggilan spasi
        String jenisKelamin = (String) jComboBox1.getSelectedItem();
        String asal = jTextFieldAsal.getText();
        
         
        tbl.addRow(new Object[]{jTextFieldNama.getText(), jComboBox1.getSelectedItem(), jTextFieldAsal.getText()});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BelajarInputTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BelajarInputTable().setVisible(true);
            }
        });
    }
